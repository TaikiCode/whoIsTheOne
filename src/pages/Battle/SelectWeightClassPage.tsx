  ...
  return (
    <div className="h-screen w-screen flexColCenter">
      ...
      <div className="h-1/5 w-1/3 flex justify-around items-center">
        <button onClick={() => history.push('/')} className="btn btn-outline btn-warning">Homeに戻る</button>
        <button onClick={() => history.push(`/battle/${selectedClass}`)} className="btn btn-primary" disabled={!selectedClass}>
          対戦する
        </button>
      </div>
    </div>
